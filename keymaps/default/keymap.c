...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT(                                                                                                                   //Splitt  
    ...
    KC_ESCAPE	,         KC_1,           KC_2,           KC_3,           KC_4,           KC_5,       KC_NO,     KC_NO,                KC_NO,             KC_NO,       KC_6,     KC_7,       KC_8,    KC_9,            KC_0,           KC_END,
    KC_TAB    ,         KC_Q,           KC_W,           KC_E,           KC_R,           KC_T,       LogMakro,  KC_NO,                KC_NO,             KC_NO,       DE_Z,     KC_U,       KC_I,    KC_O,            KC_P,           KC_DELETE,
    ...
    KC_LEFT_CTRL,       KC_LEFT_GUI,    KC_LALT,        MO(_NumL),      MO(_FuncL),     KC_SPACE, KC_BACKSPACE,KC_ENTER,           KC_ENTER,       KC_BACKSPACE,   KC_SPACE,  MO(_NavL),  KC_O,    KC_RIGHT_ALT,    KC_RIGHT_GUI,   KC_RIGHT_CTRL
  ),
  ...
  [_FuncL] = LAYOUT(                                                                                                               //Splitt       
    ...
    KC_TRNS,           DE_LABK ,       KC_NO,          KC_NO,          KC_NO,          KC_NO,      KC_NO,    KC_NO,                KC_NO,            KC_NO,        KC_NO,    KC_NO,         KC_NO,  KC_NO,           KC_NO,         KC_NO,
  ...
  [_NumL] = LAYOUT(                                                                                                         //Splitt                
    ...
    KC_NO,             DE_RPRN ,       DE_RCBR ,       DE_RBRC ,       KC_NO,          KC_NO,      KC_NO,    KC_NO,                KC_NO,            KC_NO,        KC_NO,    KC_P7,         KC_P8,  KC_P9,           KC_NO,         KC_NO,
